...
import { getDevices, updateDevice } from '../firebaseConfig';
  ...
  const fetchDeviceDetails = async () => {
    ...
    if (result.success) {
      ...
      if (foundDevice) {
        ...
        // Load captured images from device data
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">The requested driver profile could not be found.</p>
          <button
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">Comprehensive driver information and statistics</p>
            </div>
        ...
        >
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-1">{device.driverName || 'Unknown Driver'}</h2>
              <p className="text-cyan-400 font-mono text-sm mb-2">{device.driverId || 'N/A'}</p>
              <p className="text-gray-400 text-sm">{device.driverAge ? `${device.driverAge} years old` : 'Age N/A'}</p>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">{device.contactNumber || 'Not provided'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-mono">{device.licenseNo || 'Not provided'}</p>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-mono">{device.vehicleNumber || 'Not provided'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-mono">{device.deviceId || 'N/A'}</p>
                  </div>
                </div>
              </div>
            </div>
