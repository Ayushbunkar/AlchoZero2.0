...
export const Button = ({ children, onClick, variant = 'primary', className = '', ...rest }) => {
  ...
  const variants = {
    primary: 'bg-[var(--success-green)] text-white hover:bg-[var(--success-green)]/90 border border-[var(--success-green)]/20 focus:ring-2 ring-[var(--success-green)]/40',
    danger: 'bg-[var(--error-red)] text-white hover:bg-[var(--error-red)]/90 focus:ring-2 ring-[var(--error-red)]/40',
