...
const Signup = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#0a0a0a] flex items-center justify-center px-4 py-24">
      {/* Background Effects */}
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8">
          ...
          {success && (
            ...
            >
              ...
              <div>
                <p className="text-sm text-green-400 font-semibold">Account created successfully!</p>
                <p className="text-xs text-green-400/80 mt-1">Redirecting to login...</p>
              </div>
            </motion.div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-11 pr-12 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all"
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                id="terms"
                required
                className="w-4 h-4 mt-1 rounded border-white/10 bg-white/5 text-blue-500 focus:ring-blue-500/50 focus:ring-offset-0"
              />
